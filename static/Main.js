...
var author$project$Forecast$ClearDay = {$: 'ClearDay'};
var author$project$Forecast$ClearNight = {$: 'ClearNight'};
var author$project$Forecast$Cloudy = {$: 'Cloudy'};
var author$project$Forecast$Fog = {$: 'Fog'};
var author$project$Forecast$PartlyCloudyDay = {$: 'PartlyCloudyDay'};
var author$project$Forecast$PartlyCloudyNight = {$: 'PartlyCloudyNight'};
var author$project$Forecast$Rain = {$: 'Rain'};
var author$project$Forecast$Sleet = {$: 'Sleet'};
var author$project$Forecast$Snow = {$: 'Snow'};
var author$project$Forecast$Wind = {$: 'Wind'};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Forecast$weatherIconDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (x) {
		return elm$json$Json$Decode$succeed(
			function () {
				switch (x) {
					case 'clear-day':
						return author$project$Forecast$ClearDay;
					case 'clear-night':
						return author$project$Forecast$ClearNight;
					case 'rain':
						return author$project$Forecast$Rain;
					case 'snow':
						return author$project$Forecast$Snow;
					case 'sleet':
						return author$project$Forecast$Sleet;
					case 'wind':
						return author$project$Forecast$Wind;
					case 'fog':
						return author$project$Forecast$Fog;
					case 'cloudy':
						return author$project$Forecast$Cloudy;
					case 'partly-cloudy-day':
						return author$project$Forecast$PartlyCloudyDay;
					case 'partly-cloudy-night':
						return author$project$Forecast$PartlyCloudyNight;
					default:
						return author$project$Forecast$Cloudy;
				}
			}());
...
var author$project$Forecast$DailyForecastDetail = function (time) {
	return function (summary) {
		return function (icon) {
			return function (sunriseTime) {
				return function (sunsetTime) {
					return function (precipIntensity) {
						return function (precipProbability) {
							return function (precipType) {
								return function (temperatureHigh) {
									return function (temperatureHighTime) {
										return function (temperatureLow) {
											return function (temperatureLowTime) {
												return function (windSpeed) {
													return function (windGust) {
														return function (windBearing) {
															return function (detailSelected) {
																return {detailSelected: detailSelected, icon: icon, precipIntensity: precipIntensity, precipProbability: precipProbability, precipType: precipType, summary: summary, sunriseTime: sunriseTime, sunsetTime: sunsetTime, temperatureHigh: temperatureHigh, temperatureHighTime: temperatureHighTime, temperatureLow: temperatureLow, temperatureLowTime: temperatureLowTime, time: time, windBearing: windBearing, windGust: windGust, windSpeed: windSpeed};
															};
														};
													};
												};
...
var author$project$Forecast$East = {$: 'East'};
var author$project$Forecast$North = {$: 'North'};
var author$project$Forecast$Northeast = {$: 'Northeast'};
var author$project$Forecast$Northwest = {$: 'Northwest'};
var author$project$Forecast$South = {$: 'South'};
var author$project$Forecast$Southeast = {$: 'Southeast'};
var author$project$Forecast$Southwest = {$: 'Southwest'};
var author$project$Forecast$West = {$: 'West'};
...
var author$project$Forecast$bearingDirectionDecoder = function () {
	var bearingDirectionFromInt = function (degrees) {
		var bearingDirectionMap = F2(
			function (bearingDirection, range) {
				return A2(
					elm$core$List$map,
					function (x) {
						return _Utils_Tuple2(bearingDirection, x);
					},
					range);
			});
		var east = A2(
			bearingDirectionMap,
			author$project$Forecast$East,
			A2(elm$core$List$range, 69, 113));
		var north = A2(
			bearingDirectionMap,
			author$project$Forecast$North,
			_Utils_ap(
				A2(elm$core$List$range, 339, 359),
				A2(elm$core$List$range, 0, 23)));
		var northEast = A2(
			bearingDirectionMap,
			author$project$Forecast$Northeast,
			A2(elm$core$List$range, 24, 68));
		var northWest = A2(
			bearingDirectionMap,
			author$project$Forecast$Northwest,
			A2(elm$core$List$range, 294, 338));
		var south = A2(
			bearingDirectionMap,
			author$project$Forecast$South,
			A2(elm$core$List$range, 159, 203));
		var southEast = A2(
			bearingDirectionMap,
			author$project$Forecast$Southeast,
			A2(elm$core$List$range, 114, 158));
		var southWest = A2(
			bearingDirectionMap,
			author$project$Forecast$Southwest,
			A2(elm$core$List$range, 204, 248));
		var west = A2(
			bearingDirectionMap,
			author$project$Forecast$West,
			A2(elm$core$List$range, 249, 293));
		var allDirections = _Utils_ap(
			north,
			_Utils_ap(
				northEast,
				_Utils_ap(
	...
	return A2(
		elm$json$Json$Decode$andThen,
		function (x) {
			var _n0 = bearingDirectionFromInt(x);
			if (_n0.$ === 'Just') {
				var bearingDirection = _n0.a;
				return elm$json$Json$Decode$succeed(bearingDirection);
			} else {
				return elm$json$Json$Decode$fail(
					'Degrees for bearing direction out of range (must be between 0 and 359): ' + elm$core$String$fromInt(x));
			}
		},
		elm$json$Json$Decode$int);
}();
...
var author$project$Forecast$dailyForecastDetailDecoder = A4(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'detailSelected',
	...
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'windBearing',
		author$project$Forecast$bearingDirectionDecoder,
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'windGust',
			elm$json$Json$Decode$float,
													...
													A3(
														...
														A3(
															...
															A3(
																...
																'time',
																author$project$Forecast$unixTimeDecoder,
																elm$json$Json$Decode$succeed(author$project$Forecast$DailyForecastDetail)))))))))))))))));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Forecast$dailyForecastSummaryDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'data',
	elm$json$Json$Decode$list(author$project$Forecast$dailyForecastDetailDecoder),
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'icon',
		author$project$Forecast$weatherIconDecoder,
		A3(
			...
			'summary',
			elm$json$Json$Decode$string,
			elm$json$Json$Decode$succeed(author$project$Forecast$DailyForecastSummary))));
var author$project$Forecast$HourlyForecastSummary = F3(
	function (summary, icon, data) {
		return {data: data, icon: icon, summary: summary};
	});
						...
						return function (temperature) {
							return function (windSpeed) {
								return function (windGust) {
									return function (windBearing) {
										return function (detailSelected) {
											return {detailSelected: detailSelected, icon: icon, precipIntensity: precipIntensity, precipProbability: precipProbability, precipType: precipType, summary: summary, temperature: temperature, time: time, windBearing: windBearing, windGust: windGust, windSpeed: windSpeed};
										};
									};
								};
							};
...
var author$project$Forecast$hourlyForecastDetailDecoder = A4(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'detailSelected',
	elm$json$Json$Decode$bool,
	false,
...
var author$project$Forecast$hourlyForecastSummaryDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'data',
	elm$json$Json$Decode$list(author$project$Forecast$hourlyForecastDetailDecoder),
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'icon',
		author$project$Forecast$weatherIconDecoder,
		A3(
			...
			'summary',
			elm$json$Json$Decode$string,
			elm$json$Json$Decode$succeed(author$project$Forecast$HourlyForecastSummary))));
var author$project$Forecast$forecastSummaryDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'daily',
	author$project$Forecast$dailyForecastSummaryDecoder,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'hourly',
...
var author$project$Main$baseUrl = 'http://localhost:5000/';
var author$project$Msg$GotForecastSummary = function (a) {
...
var author$project$Main$getForecastSummary = function (location) {
	var url = author$project$Main$baseUrl + ('forecast?latitude=' + (elm$core$String$fromFloat(location.latitude) + ('&longitude=' + elm$core$String$fromFloat(location.longitude))));
	return elm$http$Http$get(
		{
			expect: A2(elm$http$Http$expectJson, author$project$Msg$GotForecastSummary, author$project$Forecast$forecastSummaryDecoder),
			url: url
		});
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		var addErrorData = function (err) {
			var _n3 = A2(elm$core$Debug$log, 'error', err);
			return _Utils_update(
				model,
				{
					errorData: A2(elm$core$List$cons, err, model.errorData)
				});
		};
		switch (msg.$) {
			case 'GotForecastSummary':
				var result = msg.a;
				if (result.$ === 'Err') {
					var e = result.a;
					return _Utils_Tuple2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								forecastSummary: elm$core$Maybe$Just(summary)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'Here':
			...
			default:
				...
				var updatedModel = function () {
					var _n2 = model.forecastSummary;
					if (_n2.$ === 'Nothing') {
						return model;
					} else {
						var summary = _n2.a;
						var hfs = summary.hourlyForecastSummary;
						var hfd = summary.hourlyForecastSummary.data;
						var updatedHfd = A2(
							elm$core$List$map,
							function (x) {
								return _Utils_eq(x.time, detail.time) ? _Utils_update(
									x,
									{detailSelected: true}) : _Utils_update(
									x,
									{detailSelected: false});
							},
							hfd);
						var updatedHfs = _Utils_update(
							hfs,
							{data: updatedHfd});
						var updatedSummary = _Utils_update(
							summary,
							{hourlyForecastSummary: updatedHfs});
						return _Utils_update(
							model,
							{
								forecastSummary: elm$core$Maybe$Just(updatedSummary)
							});
					}
				}();
...
var author$project$Msg$ChangeApplicationView = function (a) {
	return {$: 'ChangeApplicationView', a: a};
};
var author$project$Model$DailyForecasts = {$: 'DailyForecasts'};
var author$project$Model$HourlyForecasts = {$: 'HourlyForecasts'};
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class(
							author$project$Forecast$weatherIconAsClass(icon))
						]),
					_List_Nil)
				]));
	});
...
var author$project$View$currentForecastView = F2(
	function (forecastSummary, zone) {
		var iconCard = F3(
			function (label, icons, appView) {
				return A2(
					elm$html$Html$div,
					_List_fromArray(
						[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('card my-2'),
											A2(elm$html$Html$Attributes$style, 'width', '24rem'),
											A2(elm$html$Html$Attributes$style, 'cursor', 'pointer'),
											elm$html$Html$Events$onClick(
											author$project$Msg$ChangeApplicationView(appView))
										]),
									_List_fromArray(
										[
											A2(
		...
		var getIcons = function (forecasts) {
			return A2(
				elm$html$Html$h4,
				_List_Nil,
				A2(
					elm$core$List$map,
					function (x) {
						return A2(author$project$View$weatherIconView, x, 1);
					},
					A2(
						elm$core$List$map,
						function (x) {
						...
						A2(elm$core$List$take, 8, forecasts.data))));
		};
		var hourlyIcons = getIcons(forecastSummary.hourlyForecastSummary);
		var dailyIcons = getIcons(forecastSummary.dailyForecastSummary);
		var current = forecastSummary.currentForecastSummary;
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(author$project$View$weatherIconView, current.icon, 0)
										]))
								]))
						])),
					A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$text(
											current.summary + ('. It\'s ' + (A2(myrho$elm_round$Round$round, 0, current.temperature) + 'º outside.')))
										]))
								]))
						])),
					A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											function () {
											var precipProbabilityFragment = function () {
												var _n0 = A2(myrho$elm_round$Round$round, 0, current.precipProbability);
												if (_n0 === '0') {
													return 'Right now, ';
												} else {
													var p = _n0;
													return 'Right now, there\'s a ' + (p + '% chance of precipitation, and ');
												}
											}();
											return elm$html$Html$text(
												precipProbabilityFragment + ('the wind is blowing at ' + (A2(myrho$elm_round$Round$round, 0, current.windSpeed) + ' MPH.')));
										}()
										]))
								]))
						])),
					A3(iconCard, 'Hourly', hourlyIcons, author$project$Model$HourlyForecasts),
					A3(iconCard, 'Daily', dailyIcons, author$project$Model$DailyForecasts)
				]));
	});
...
var author$project$HumanDates$weekdayToString = function (w) {
	switch (w.$) {
		case 'Sun':
			return 'Sunday';
		case 'Mon':
...
var author$project$HumanDates$prettyDay = F2(
	function (zone, posix) {
		var weekday = author$project$HumanDates$weekdayToString(
			A2(elm$time$Time$toWeekday, zone, posix));
		var month = author$project$HumanDates$monthToString(
...
var author$project$HumanDates$prettyHourMinute = F2(
	function (zone, posix) {
		var minuteRaw = A2(elm$time$Time$toMinute, zone, posix);
		var minute = function () {
			var _n3 = minuteRaw < 10;
			if (_n3) {
				return '0' + elm$core$String$fromInt(minuteRaw);
			} else {
				return elm$core$String$fromInt(minuteRaw);
			}
		}();
		var hourRaw = A2(elm$time$Time$toHour, zone, posix);
		var _n0 = function () {
			var _n1 = hourRaw > 12;
			if (_n1) {
...
var author$project$View$dailyForecastView = F2(
	function (summary, zone) {
		...
		var next8days = A2(elm$core$List$take, 8, summary.data);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Msg$SelectHourlyForecastDetail = function (a) {
	return {$: 'SelectHourlyForecastDetail', a: a};
};
				...
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('col'),
							elm$html$Html$Events$onClick(
							author$project$Msg$SelectHourlyForecastDetail(detail)),
							A2(elm$html$Html$Attributes$style, 'cursor', 'pointer')
						]),
					_List_fromArray(
						[
...
var author$project$View$hourlyForecastView = F2(
	function (summary, zone) {
		var topRow = A2(
			elm$html$Html$div,
			_List_fromArray(
		...
		var next24hours = A2(elm$core$List$take, 24, summary.data);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			var titleDiv = A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('row'),
						elm$html$Html$Events$onClick(
						author$project$Msg$ChangeApplicationView(author$project$Model$CurrentForecast))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Mist Opportunities')
									]))
							]))
					]));
			var _n0 = model.forecastSummary;
			if (_n0.$ === 'Nothing') {
				return _List_fromArray(
					[
						titleDiv,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										function () {
										var _n1 = model.applicationView;
										switch (_n1.$) {
											case 'CurrentForecast':
												return A2(author$project$View$currentForecastView, summary, model.zone);
											case 'HourlyForecasts':
												return A2(author$project$View$hourlyForecastView, summary.hourlyForecastSummary, model.zone);
											default:
												return A2(author$project$View$dailyForecastView, summary.dailyForecastSummary, model.zone);
										}
									}()
									]))
							]))
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'longitude', elm$json$Json$Decode$float)))({"versions":{"elm":"0.19.0"},"types":{"message":"Msg.Msg","aliases":{"Forecast.CurrentForecastSummary":{"args":[],"type":"{ time : Time.Posix, summary : String.String, icon : Forecast.WeatherIcon, precipProbability : Basics.Float, temperature : Basics.Float, windSpeed : Basics.Float }"},"Forecast.DailyForecastDetail":{"args":[],"type":"{ time : Time.Posix, summary : String.String, icon : Forecast.WeatherIcon, sunriseTime : Time.Posix, sunsetTime : Time.Posix, precipIntensity : Basics.Float, precipProbability : Basics.Float, precipType : String.String, temperatureHigh : Basics.Float, temperatureHighTime : Time.Posix, temperatureLow : Basics.Float, temperatureLowTime : Time.Posix, windSpeed : Basics.Float, windGust : Basics.Float, windBearing : Forecast.BearingDirection, detailSelected : Basics.Bool }"},"Forecast.DailyForecastSummary":{"args":[],"type":"{ summary : String.String, icon : Forecast.WeatherIcon, data : List.List Forecast.DailyForecastDetail }"},"Forecast.ForecastSummary":{"args":[],"type":"{ latitude : Basics.Float, longitude : Basics.Float, timezone : String.String, currentForecastSummary : Forecast.CurrentForecastSummary, hourlyForecastSummary : Forecast.HourlyForecastSummary, dailyForecastSummary : Forecast.DailyForecastSummary }"},"Forecast.HourlyForecastDetail":{"args":[],"type":"{ time : Time.Posix, summary : String.String, icon : Forecast.WeatherIcon, precipIntensity : Basics.Float, precipProbability : Basics.Float, precipType : String.String, temperature : Basics.Float, windSpeed : Basics.Float, windGust : Basics.Float, windBearing : Forecast.BearingDirection, detailSelected : Basics.Bool }"},"Forecast.HourlyForecastSummary":{"args":[],"type":"{ summary : String.String, icon : Forecast.WeatherIcon, data : List.List Forecast.HourlyForecastDetail }"},"Time.Era":{"args":[],"type":"{ start : Basics.Int, offset : Basics.Int }"}},"unions":{"Msg.Msg":{"args":[],"tags":{"GotForecastSummary":["Result.Result Http.Error Forecast.ForecastSummary"],"Here":["Time.Zone"],"ChangeApplicationView":["Model.ApplicationView"],"SelectHourlyForecastDetail":["Forecast.HourlyForecastDetail"]}},"Forecast.BearingDirection":{"args":[],"tags":{"North":[],"Northeast":[],"East":[],"Southeast":[],"South":[],"Southwest":[],"West":[],"Northwest":[]}},"Forecast.WeatherIcon":{"args":[],"tags":{"ClearDay":[],"ClearNight":[],"Rain":[],"Snow":[],"Sleet":[],"Wind":[],"Fog":[],"Cloudy":[],"PartlyCloudyDay":[],"PartlyCloudyNight":[]}},"Model.ApplicationView":{"args":[],"tags":{"CurrentForecast":[],"HourlyForecasts":[],"DailyForecasts":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Time.Zone":{"args":[],"tags":{"Zone":["Basics.Int","List.List Time.Era"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));